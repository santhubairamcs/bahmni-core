...
public class ObsToObsTabularFlowSheetController {
    ...
    public PivotTable constructPivotTableFor(
            ...
            @RequestParam(value = "name", required = false) String groovyExtensionFileName) {
        ...
        BaseTableExtension<PivotTable> extension = bahmniExtensions.getExtension(groovyExtensionFileName);
